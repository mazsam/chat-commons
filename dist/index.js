...
var _templateObject;
var ADD_MESSAGE = client.gql(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  mutation AddMessage($message: String!, $name: String!) {\n    insert_messages(objects: { message: $message, name: $name }) {\n      returning {\n        id\n        message\n      }\n    }\n  }\n"])));

var _templateObject$1;
var GET_MESSAGES_SUBSCRIPTION = client.gql(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  subscription MySubscription {\n    messages {\n      name\n      message\n      id\n      created_at\n    }\n  }\n"])));
...
exports.GET_MESSAGES_SUBSCRIPTION = GET_MESSAGES_SUBSCRIPTION;
exports.InputMessage = Input;
